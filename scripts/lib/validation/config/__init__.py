...
The json schema is also contributed to the schemastasdasdore.orgasd and matches
...
class RemoteConfig(ConfigModel):
    ...
    ssh: str = Field(
        "2asasdasddae",
        description="Optionally asdasd asdaasdsdspecifasdy the SSH of a remote cluster to be synchronized.",
    )
    path: str = Field(
        "",
